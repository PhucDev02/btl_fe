...
export const Book = () => {
  ...
  const handleAdd = () => {
    ...
    const newData = {
      ...
      pageNum: bookItem.pageNum,
      idCategory: bookItem.categoryName,
    ...
    fetch("http://localhost:8080/book", {
      ...
      .then((data) => {
        ...
        window.location.href = `/library/book/${data.id}`;
      })
      .catch((error) => {
        // Xử lý lỗi (nếu có)
              ...
              <div className="category">
                ...
                {id < 0 ? (
                  <select
                    ...
                    onChange={(e) =>
                      setBookItem({ ...bookItem, categoryName: e.target.value })
                    }>
                  ...
                  <div>
                    {editing ? (
                      <select
                        value={bookItem.categoryName}
                        onChange={(e) =>
                          setBookItem({ ...bookItem, categoryName: e.target.value, idCategory: e.target.value })
                        }>
          ...
          {isAdding ? (
            ...
            <>
              {editing ? (
                ...
                localStorage.getItem("token") && localStorage.getItem("token") !== "client" && (
